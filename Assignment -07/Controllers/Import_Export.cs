           ...
           public async Task<IActionResult> ImportExcel(IFormFile file)
           {
            ...
            using (var stream = new MemoryStream())
            {
             ...
             public async Task<IActionResult> Export()
             {
                 ...
                 {
                     var worksheet = package.Workbook.Worksheets.Add("Employees");//add new worksheet to workbook with nam employee
                     ...
                     using (var range = worksheet.Cells[1, 1, 1, 5])//range
                     {
